...
// === 简化导出 ===
if (typeof module !== "undefined" && module.exports) {
    module.exports["test-module-a"] = TestModuleA;
}
if (typeof module !== "undefined" && module.exports) {
    module.exports["test-module-b"] = TestModuleB;
}
...
function runAutoTest() {
    ...
    console.log("test-module-a 可用: " + (typeof test-module-a !== "undefined"));
    console.log("test-module-b 可用: " + (typeof test-module-b !== "undefined"));
    
    // 测试模块间调用
    try {
        if (test-module-a && test-module-b) {
