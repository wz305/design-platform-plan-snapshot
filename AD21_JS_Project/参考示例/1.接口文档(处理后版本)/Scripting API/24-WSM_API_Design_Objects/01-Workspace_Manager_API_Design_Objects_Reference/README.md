...
- [<a id="IDMObject_interface"></a>IDMObject interface](01-a_id_IDMObject_interface_a_IDMObject_interface.md.md)
- [<a id="IWorkspace_interface"></a>IWorkspace interface](02-a_id_IWorkspace_interface_a_IWorkspace_interface.md.md)
- [<a id="IBus_interface"></a>IBus interface](03-a_id_IBus_interface_a_IBus_interface.md.md)
- [<a id="IChannelClass_interface"></a>IChannelClass interface](04-a_id_IChannelClass_interface_a_IChannelClass_interface.md.md)
- [<a id="IComponent_Interface"></a>IComponent Interface](05-a_id_IComponent_Interface_a_IComponent_Interface.md.md)
- [<a id="IComponentClass_interface"></a>IComponentClass interface](06-a_id_IComponentClass_interface_a_IComponentClass_interface.md.md)
- [<a id="IComponentImplementation_interface"></a>IComponentImplementation interface](07-a_id_IComponentImplementation_interface_a_IComponentImplementation_interface.md.md)
- [<a id="ICrossSheet_interface"></a>ICrossSheet interface](08-a_id_ICrossSheet_interface_a_ICrossSheet_interface.md.md)
- [<a id="ILine_Interface"></a>ILine Interface](09-a_id_ILine_Interface_a_ILine_Interface.md.md)
- [<a id="INet_interface"></a>INet interface](10-a_id_INet_interface_a_INet_interface.md.md)
- [<a id="INetClass_interface"></a>INetClass interface](11-a_id_INetClass_interface_a_INetClass_interface.md.md)
- [<a id="INetItem_Interface"></a>INetItem Interface](12-a_id_INetItem_Interface_a_INetItem_Interface.md.md)
- [<a id="INetLabel_interface"></a>INetLabel interface](13-a_id_INetLabel_interface_a_INetLabel_interface.md.md)
- [<a id="IObjectClass_interface"></a>IObjectClass interface](14-a_id_IObjectClass_interface_a_IObjectClass_interface.md.md)
- [<a id="IParameter_interface"></a>IParameter interface](15-a_id_IParameter_interface_a_IParameter_interface.md.md)
- [IParameter interface](16-IParameter_interface.md.md)
- [<a id="IPart_interface"></a>IPart interface](17-a_id_IPart_interface_a_IPart_interface.md.md)
- [<a id="IPin_interface"></a>IPin interface](18-a_id_IPin_interface_a_IPin_interface.md.md)
- [<a id="IPort_interface"></a>IPort interface](19-a_id_IPort_interface_a_IPort_interface.md.md)
- [<a id="IPowerObject_interface"></a>IPowerObject interface](20-a_id_IPowerObject_interface_a_IPowerObject_interface.md.md)
- [<a id="IRoom_Interface"></a>IRoom interface](21-a_id_IRoom_Interface_a_IRoom_interface.md.md)
- [IRoom Interface](22-IRoom_Interface.md.md)
- [<a id="IRule_Interface"></a>IRule Interface](23-a_id_IRule_Interface_a_IRule_Interface.md.md)
- [<a id="ISheetSymbol_Interface"></a>ISheetSymbol Interface](24-a_id_ISheetSymbol_Interface_a_ISheetSymbol_Interface.md.md)
- [<a id="ISheetEntry_interface"></a>ISheetEntry interface](25-a_id_ISheetEntry_interface_a_ISheetEntry_interface.md.md)
- [<a id="ITextFrame_Interface"></a>ITextFrame Interface](26-a_id_ITextFrame_Interface_a_ITextFrame_Interface.md.md)
- [<a id="IViolation_Interface"></a>IViolation Interface](27-a_id_IViolation_Interface_a_IViolation_Interface.md.md)
- [<a id="IWrapper_Interface"></a>IWrapper Interface](28-a_id_IWrapper_Interface_a_IWrapper_Interface.md.md)
