...
- [IConnection Interface](01-IConnection_Interface.md.md)
- [<a id="IConnectionsArray_Interface"></a>IConnectionsArray Interface](02-a_id_IConnectionsArray_Interface_a_IConnectionsArray_Interface.md.md)
- [<a id="ISch_Document_Interface"></a>ISch\_Document Interface](03-a_id_ISch_Document_Interface_a_ISch_Document_Interface.md.md)
- [<a id="ISch_Sheet_Interface"></a>ISch\_Sheet Interface](04-a_id_ISch_Sheet_Interface_a_ISch_Sheet_Interface.md.md)
- [<a id="ISch_Lib_Interface"></a>ISch\_Lib Interface](05-a_id_ISch_Lib_Interface_a_ISch_Lib_Interface.md.md)
- [<a id="ISch_BasicContainer_Interface"></a>ISch\_BasicContainer Interface](06-a_id_ISch_BasicContainer_Interface_a_ISch_BasicContainer_Interface.md.md)
- [<a id="ISch_GraphicalObject_Interface"></a>ISch\_GraphicalObject Interface](07-a_id_ISch_GraphicalObject_Interface_a_ISch_GraphicalObject_Interface.md.md)
- [<a id="ISch_RobotManager_Interface"></a>ISch\_RobotManager Interface](08-a_id_ISch_RobotManager_Interface_a_ISch_RobotManager_Interface.md.md)
- [<a id="ISch_ServerInterface_Interface"></a>ISch\_ServerInterface Interface](09-a_id_ISch_ServerInterface_Interface_a_ISch_ServerInterface_Interface.md.md)
- [<a id="ISch_Preferences_Interface"></a>ISch\_Preferences Interface](10-a_id_ISch_Preferences_Interface_a_ISch_Preferences_Interface.md.md)
- [<a id="IGridSetting_interface"></a>IGridSetting interface](11-a_id_IGridSetting_interface_a_IGridSetting_interface.md.md)
- [<a id="ISch_FontManager"></a>ISch\_FontManager](12-a_id_ISch_FontManager_a_ISch_FontManager.md.md)
- [<a id="ISch_FontManager2_Interface"></a>ISch\_FontManager2 Interface](13-a_id_ISch_FontManager2_Interface_a_ISch_FontManager2_Interface.md.md)
- [<a id="ISch_JunctionConvertSettings_Interface"></a>ISch\_JunctionConvertSettings Interface](14-a_id_ISch_JunctionConvertSettings_Interface_a_ISch_JunctionConvertSettings_Interface.md.md)
- [<a id="ISch_LibraryRuleChecker_Interface"></a>ISch\_LibraryRuleChecker Interface](15-a_id_ISch_LibraryRuleChecker_Interface_a_ISch_LibraryRuleChecker_Interface.md.md)
- [<a id="ISch_HitTest_Interface"></a>ISch\_HitTest Interface](16-a_id_ISch_HitTest_Interface_a_ISch_HitTest_Interface.md.md)
- [<a id="ISch_Iterator_Interface"></a>ISch\_Iterator Interface](17-a_id_ISch_Iterator_Interface_a_ISch_Iterator_Interface.md.md)
- [<a id="ILibCompInfoReader_Interface"></a>ILibCompInfoReader Interface](18-a_id_ILibCompInfoReader_Interface_a_ILibCompInfoReader_Interface.md.md)
- [<a id="IComponentInfo_Interface"></a>IComponentInfo Interface](19-a_id_IComponentInfo_Interface_a_IComponentInfo_Interface.md.md)
- [<a id="IComponentPainterView_Interface"></a>IComponentPainterView Interface](20-a_id_IComponentPainterView_Interface_a_IComponentPainterView_Interface.md.md)
- [<a id="IComponentPinSelectionListener_Interface"></a>IComponentPinSelectionListener Interface](21-a_id_IComponentPinSelectionListener_Interface_a_IComponentPinSelectionListener_Interface.md.md)
- [<a id="IComponentMetafilePainter"></a>IComponentMetafilePainter](22-a_id_IComponentMetafilePainter_a_IComponentMetafilePainter.md.md)
- [<a id="IDocumentPainterView_Interface"></a>IDocumentPainterView Interface](23-a_id_IDocumentPainterView_Interface_a_IDocumentPainterView_Interface.md.md)
