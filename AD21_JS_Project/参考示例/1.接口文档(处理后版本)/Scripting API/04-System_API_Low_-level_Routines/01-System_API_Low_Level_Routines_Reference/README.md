...
- [<a id="Scale_Factor_Table"></a>Scale Factor Table](01-a_id_Scale_Factor_Table_a_Scale_Factor_Table.md.md)
- [<a id="Constants"></a>Constants](02-a_id_Constants_a_Constants.md.md)
- [<a id="Conversion_Routines"></a>Conversion Routines](03-a_id_Conversion_Routines_a_Conversion_Routines.md.md)
- [<a id="Enumerated_Types"></a>Enumerated Types](04-a_id_Enumerated_Types_a_Enumerated_Types.md.md)
- [<a id="Dialogs"></a>Dialogs](05-a_id_Dialogs_a_Dialogs.md.md)
- [<a id="File_IO"></a>File IO](06-a_id_File_IO_a_File_IO.md.md)
- [<a id="Number_Manipulation_Routines"></a>Number Manipulation Routines](07-a_id_Number_Manipulation_Routines_a_Number_Manipulation_Routines.md.md)
- [<a id="Other_Routines"></a>Other Routines](08-a_id_Other_Routines_a_Other_Routines.md.md)
- [<a id="Special_Folder_Path_Strings"></a>Special Folder Path Strings](09-a_id_Special_Folder_Path_Strings_a_Special_Folder_Path_Strings.md.md)
- [<a id="String_Routines"></a>String Routines](10-a_id_String_Routines_a_String_Routines.md.md)
- [<a id="Time_and_Date_Routines"></a>Time and Date Routines](11-a_id_Time_and_Date_Routines_a_Time_and_Date_Routines.md.md)
- [<a id="Functions_from_ClientProcs_unit"></a>Functions from ClientProcs unit](12-a_id_Functions_from_ClientProcs_unit_a_Functions_from_ClientProcs_unit.md.md)
